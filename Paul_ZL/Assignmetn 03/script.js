...
const definitionName = "box.gh";

// Set up sliders
const nos_slider = document.getElementById("nos");
nos_slider.addEventListener("mouseup", onSliderChange, false);
nos_slider.addEventListener("touchend", onSliderChange, false);
...
async function compute() {
  const param1 = new RhinoCompute.Grasshopper.DataTree("nos");
  param1.append([0], [nos_slider.valueAsNumber]);
